...
from helper_func import decode, get_messages, subsall, subsch1, subsch2, subsch3, subsch4
...
@Bot.on_message(filters.command("start") & filters.private & subsall & subsch1 & subsch2 & subsch3 & subsch4)
...
@Bot.on_message(filters.command("broadcast") & filters.user(ADMINS, 5493260414))
